        ...
        <div className="relative z-10 max-w-6xl mx-auto px-6">
          ...
          <div className="mt-16 flex flex-col sm:flex-row justify-center gap-5">
            ...
            <motion.button
              ...
              whileTap={{ scale: 0.96 }}
              className="inline-flex items-center gap-3 px-16 py-6 rounded-full font-semibold text-white bg-gradient-to-r from-emerald-500 to-blue-600 shadow-xl"
            >
              Call Now
            </motion.button>
            ...
            <motion.button
              ...
              whileHover={{ y: -2 }}
              whileTap={{ scale: 0.96 }}
              className="px-12 py-6 rounded-full font-semibold text-emerald-700 bg-emerald-50 border border-emerald-200 shadow-sm flex items-center gap-3"
            >
